...
export const onRequestPost: PagesFunction<Env> = async ({ request, env }) => {
  try {
    ...
    const listing: Listing = {
      ...
      boatModel: body.boatModel?.toString() || existingObj.boatModel,
      boatClass: body.boatClass?.toString() || existingObj.boatClass,
      ...
      engine: body.engine?.toString() || existingObj.engine,
      power: typeof body.power === 'number' ? body.power : existingObj.power,
      engineHours: typeof body.engineHours === 'number' ? body.engineHours : existingObj.engineHours,
      capacity: typeof body.capacity === 'number' ? body.capacity : existingObj.capacity,
